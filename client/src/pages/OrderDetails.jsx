      ...
      <div className="order-details-container">
        ...
        <div className="shipping-info">
          ...
          <p>
            ...
            {order.shippingInfo.locality}, {order.shippingInfo.city},{" "}
            {order.shippingInfo.state} - {order.shippingInfo.pincode}
          </p>
          {order.shippingInfo.landmark && (
            <p>
              <strong>Landmark:</strong> {order.shippingInfo.landmark}
            </p>
          )}
          <p>
            <strong>Type:</strong> {order.shippingInfo.addressType}
          </p>
        </div>
